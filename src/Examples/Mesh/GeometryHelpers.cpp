...
namespace Examples
{
    namespace GeometryHelpers
    {
        ...
        void BuildBox(const Eegeo::v3& halfDimensions, std::vector<Vertex>& out_vertices, std::vector<u16>& out_triangleIndices)
        {
            ...
            out_triangleIndices.reserve(12);
            ...
            out_triangleIndices.push_back(3);
            out_triangleIndices.push_back(7);
            out_triangleIndices.push_back(5);
            out_triangleIndices.push_back(4);
            out_triangleIndices.push_back(4);
            out_triangleIndices.push_back(6);
            out_triangleIndices.push_back(7);
            
            out_vertices.push_back(Vertex(Eegeo::v3(halfDimensions.x * -2.0, halfDimensions.y * -1.1, halfDimensions.z * 1.0), Eegeo::v3(1.f, 0.f, 0.f), Eegeo::v2(0.0, 0.0)));
            out_vertices.push_back(Vertex(Eegeo::v3(halfDimensions.x * -0.2, halfDimensions.y * -1.0, halfDimensions.z * 1.0), Eegeo::v3(1.f, 0.f, 0.f), Eegeo::v2(0.5, 0.0)));
            out_vertices.push_back(Vertex(Eegeo::v3(halfDimensions.x * -2.0, halfDimensions.y * 1.1, halfDimensions.z * 1.0), Eegeo::v3(1.f, 0.f, 0.f), Eegeo::v2(0.0, 1.0)));
            out_vertices.push_back(Vertex(Eegeo::v3(halfDimensions.x * -0.2, halfDimensions.y * 1.0, halfDimensions.z * 1.0), Eegeo::v3(1.f, 0.f, 0.f), Eegeo::v2(0.5, 1.0)));
            out_vertices.push_back(Vertex(Eegeo::v3(halfDimensions.x * 0.2, halfDimensions.y * -1.0, halfDimensions.z * 1.0), Eegeo::v3(1.f, 0.f, 0.f), Eegeo::v2(0.5, 0.0)));
            out_vertices.push_back(Vertex(Eegeo::v3(halfDimensions.x * 2.0, halfDimensions.y * -1.1, halfDimensions.z * 1.0), Eegeo::v3(1.f, 0.f, 0.f), Eegeo::v2(1.0, 0.0)));
            out_vertices.push_back(Vertex(Eegeo::v3(halfDimensions.x * 0.2, halfDimensions.y * 1.0, halfDimensions.z * 1.0), Eegeo::v3(1.f, 0.f, 0.f), Eegeo::v2(0.5, 1.0)));
            out_vertices.push_back(Vertex(Eegeo::v3(halfDimensions.x * 2.0, halfDimensions.y * 1.1, halfDimensions.z * 1.0), Eegeo::v3(1.f, 0.f, 0.f), Eegeo::v2(1.0, 1.0)));
