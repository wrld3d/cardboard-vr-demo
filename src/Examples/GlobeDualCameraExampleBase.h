...
namespace Examples
{
    class GlobeDualCameraExampleBase : public IExample, Eegeo::NonCopyable
    {
    public:
        GlobeDualCameraExampleBase(Eegeo::Camera::GlobeCamera::GlobeCameraController* pCameraController,
                               Eegeo::Camera::GlobeCamera::GlobeCameraTouchController& cameraTouchController);
        
        virtual ~GlobeDualCameraExampleBase();
        ...
        virtual Eegeo::Camera::CameraState GetCurrentLeftCameraState() const;
        virtual Eegeo::Camera::CameraState GetCurrentRightCameraState() const;
